...
class AdobeAnalytics:
    ...
    def calculate_revenue(self):
        ...
        # read tsv file
        df = pd.read_csv(self.input_fielname, sep='\t')
        ...
        revenue_df = transformed_df.drop(['date_time', 'event_list', 'page_url', 'product_list', 'referrer', 'search_engine', 'search_keyword'], axis=1)
        ...
        output_df = output_df.rename({'search_engine': 'Search Engine Domain', 'search_keyword': 'Search Keyboard', 'revenue': 'Revenue'}, axis=1)
        print(output_df)
        ...
        output_df.to_csv('output/' + dte + '_SearchKeywordPerformance.tab', sep='\t', index=False)

# create object and execute the function
search_engine_performance = AdobeAnalytics("input/data.tsv")
search_engine_performance.calculate_revenue()
